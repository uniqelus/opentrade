...
func (m *User) validate(all bool) error {
	...
	if !_User_FirstName_Pattern.MatchString(m.GetFirstName()) {
		err := UserValidationError{
			field:  "FirstName",
			reason: "value does not match regex pattern \"^[\\\\p{L}][\\\\p{L} '\\\\-\\\\.]*$\"",
		}
		if !all {
			return err
		}
...
var _User_FirstName_Pattern = regexp.MustCompile("^[\\p{L}][\\p{L} '\\-\\.]*$")

var _User_LastName_Pattern = regexp.MustCompile("^[\\p{L}][\\p{L} '\\-\\.]*$")
